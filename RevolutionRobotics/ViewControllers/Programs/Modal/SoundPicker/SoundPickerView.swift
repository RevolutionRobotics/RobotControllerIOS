...
final class SoundPickerView: UIView {
    // MARK: - Constant
...
extension SoundPickerView: UICollectionViewDelegate {
...
extension SoundPickerView: UICollectionViewDataSource {
